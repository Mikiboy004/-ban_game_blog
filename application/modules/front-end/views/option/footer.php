				...
				<div class="col_two_third">
					...
					<div class="col_one_third">
						...
						<div class="widget clearfix">
							...
							<img src="public/assets/front-end/images/footer-widget-logo.png" alt="" class="footer-logo">

							<p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

							<div style="background: url('public/assets/front-end/images/world-map.png') no-repeat center center; background-size: 100%;">
								<address>
