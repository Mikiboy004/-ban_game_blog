                                        ...
                                        <div class="card-content text-left">
                                            <form id="register-form" class="nobottommargin" action="edit_profile" method="post" enctype="multipart/form-data">
                                                <div class="col_full text-center">
                                                    ...
                                                    <?php } elseif (isset($userlist['oauth_provider']) && isset($userlist['oauth_uid'])) { ?>
                                                        <img src="<?php echo $userlist['file_name'];  ?>" id="blah" style="border-radius: 50%;width: 20%;">
                                                    <?php } else { ?>
                                                ...
                                                <?php if (!isset($userlist['oauth_provider']) && !isset($userlist['oauth_uid'])) { ?>
                                                    <div class="col_full">
                                                ...
                                                <div class="row">
                                                    <div class="col_full col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" id="register-form-name" name="first_name" value="<?= $userlist['first_name']; ?>" class="form-control" required <?php  if (isset($userlist['oauth_provider']) && isset($userlist['oauth_uid'])) { echo 'disabled'; } ?>/>
                                                    </div>

                                                    <div class="col_full col-md-6 col-sm-12">
                                                        <label for="register-form-name">นามสกุล: <span style="color:red;">*</span></label>
                                                        <input type="text" id="register-form-name" name="last_name" value="<?= $userlist['last_name']; ?>" class="form-control" required <?php  if (isset($userlist['oauth_provider']) && isset($userlist['oauth_uid'])) { echo 'disabled'; } ?>/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col_full">
                                                    ...
                                                    <input type="text" id="register-form-email" name="email" value="<?= $userlist['email']; ?>" class="form-control" required <?php  if (isset($userlist['oauth_provider']) && isset($userlist['oauth_uid'])) { echo 'disabled'; } ?>/>
                                                </div>
                                                <?php if (!isset($userlist['oauth_provider']) && !isset($userlist['oauth_uid'])) { ?>
                                                    <div class="row">
                                                        <div class="col_full col-md-6 col-sm-12">
