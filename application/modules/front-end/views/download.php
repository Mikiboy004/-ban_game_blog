				...
				<div class="container clearfix">
					...
					<div class="clearfix center divcenter" style="max-width: 700px;">
						<div class="emphasis-title">
							<h1 class="font-secondary" style="color: #FFF; font-size: 67px; font-weight: 900; text-shadow: 0 7px 10px rgba(0,0,0,0.07), 0 4px 4px rgba(0,0,0,0.2);">ดาวน์โหลดหนังสือพิมพ์</h1>
