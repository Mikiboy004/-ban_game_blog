	...
	<div class="container clear-bottommargin clearfix">
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 bottommargin">
				<div class="ipost clearfix">
					<div class="entry-image">
						<a href="#"><img class="image_fade" src="public/assets/front-end/images/magazine/thumb/1.jpg" alt="Image"></a>
					</div>
			...
			<div class="col-lg-3 col-md-6 bottommargin">
				<div class="ipost clearfix">
					<div class="entry-image">
						<a href="#"><img class="image_fade" src="public/assets/front-end/images/magazine/thumb/2.jpg" alt="Image"></a>
					</div>
					<div class="entry-title">
			...
			<div class="col-lg-3 col-md-6 bottommargin">
				<div class="ipost clearfix">
					<div class="entry-image">
						<a href="#"><img class="image_fade" src="public/assets/front-end/images/magazine/thumb/3.jpg" alt="Image"></a>
					</div>
					<div class="entry-title">
			...
			<div class="col-lg-3 col-md-6 bottommargin">
				<div class="ipost clearfix">
					<div class="entry-image">
						<a href="#"><img class="image_fade" src="public/assets/front-end/images/magazine/thumb/4.jpg" alt="Image"></a>
					</div>
					<div class="entry-title">
