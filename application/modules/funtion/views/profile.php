                                ...
                                <form action="edit_profile" method="post">      
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="p-20">
                                                        <div class="form-group">
                                                            <label>รหัสเข้าใช้งานระบบ </label>
                                                            <input type="text" placeholder="" class="form-control" name="code" value="<?php echo $user['code_student']; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="p-20">
                                                        <div class="form-group">
                                                            <label>ชื่อผู้ใช้งาน (Username) <span style="color:red;">*</span></label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="p-20">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="" class="form-control" name="title" value="<?php echo $user['email']; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="p-20">
                                                        <div class="form-group">
                                                            <label>เบอร์โทร (Phone) <span style="color:red;">*</span></label>
                                                            <input type="text" placeholder="" class="form-control" name="first_name" value="<?php echo $user['phone']; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
