                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="search_delete?id=<?php echo $value->idT; ?>" onclick="if(confirm('แน่ใจใช่ไมที่จะลบข้อมูล?')) return true; else return false;" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                                        <?php endif; ?>
                                    </td>
                                    <?php } ?>
                                </tr>
