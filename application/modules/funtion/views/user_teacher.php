                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">ข้อมูลผู้ใช้งานอาจารย์</h4>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($user['is_admin'] == '4') :?>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                        <a class="dropdown-item" href="status_teacher=<?php echo $user['id']; ?>&status=3">ผู้ใช้งานประเภทนักศึกษา</a>
                                                                        <a class="dropdown-item" href="status_teacher=<?php echo $user['id']; ?>&status=2">ผู้ใช้งานประเภทอาจารย์</a>
                                                                        <a class="dropdown-item" href="status_teacher=<?php echo $user['id']; ?>&status=1">ผู้ใช้งานประเภททั่วไป</a>
                                        ...
                                        <?php elseif ($user['is_admin'] == '3') :?>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                        <a class="dropdown-item" href="status_teacher=<?php echo $user['id']; ?>&status=4">ผู้ดูแลระบบ</a>
                                                                        <a class="dropdown-item" href="status_teacher=<?php echo $user['id']; ?>&status=2">ผู้ใช้งานประเภทอาจารย์</a>
                                                                        <a class="dropdown-item" href="status_teacher=<?php echo $user['id']; ?>&status=1">ผู้ใช้งานประเภททั่วไป</a>
                                        ...
                                        <td> 
                                         <a href="user_teacher_edit?id=<?php echo $user['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                         <a href="delete_user_teacher?id=<?php echo $user['id']; ?>" class="btn btn-danger" onclick="return confirm('ยืนยันการลบข้อมูล')"><i class="fa fa-trash"></i></a> 
                                    </td>
                                    </tr>
                                    <?php }?>
                                    </tbody>
